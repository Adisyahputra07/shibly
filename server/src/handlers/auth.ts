...
export const addAnggotaHandler = async (req: Request, res: Response) => {
  const {
    noKtp,
    name,
    noHp,
...
export const getAnggotaHandler = async (req: Request, res: Response) => {
  try {
...
export const addAdminHandler = async (req: Request, res: Response) => {
  const {
    username,
    password,
    role,
